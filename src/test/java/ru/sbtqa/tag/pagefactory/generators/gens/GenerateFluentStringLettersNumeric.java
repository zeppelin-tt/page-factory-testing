...
public class GenerateFluentStringLettersNumeric  implements GeneratorInterface {

    private static char[] charLettersNumericDictionary = {'й','ц','у','к','е','ё','н','г','ш','щ','з','х','ъ','ф','ы',
    ...
    public String generate(String... vars) {
        ...
        return RandomStringUtils.random(rand, charLettersNumericDictionary);
    }
